...
def fixed_points_analysis():
    ...
    theta = sp.Function('theta')(time)  # pylint: disable=not-callable
    ...
    pylog.info(
        'Solution using an alternative way of solving:\n%s',
        sp.pretty(sol),
    )
    ...
    for i, s in enumerate(sol):
        ...
        pylog.info('Fixed point is a%s', fixed_point_type)
