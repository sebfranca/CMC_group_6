...
\lhead{\textit{\textbf{Computational Motor Control, Spring 2022} \\
    Python exercise, Lab 5, NOT GRADED}} \rhead{Student \\ Names}
...
\subsection*{1.a For a given stimulation, explore the relationship
  ...
  \fileref{isometric\_muscle\_system.py::IsometricMuscleSystem}
  instance to setup your experiment in \fileref{exercise1.py}}
...
\corr{Note} : Since the velocity changes sign and you need to compute
